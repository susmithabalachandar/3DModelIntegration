...
//     // Debugging: Print the fetched herb data
//     print('Fetched Herb Data: $data');

//     setState(() {
//       herbData = data;
//       print('Fetched Image Path: ${herbData?['imagePath']}');
//     });
//   }
...
//     List<String> bookmarkedHerbs =
//         prefs.getStringList('bookmarkedHerbs') ?? [];
//     setState(() {
//       isBookmarked = bookmarkedHerbs.contains(widget.herbName);
//     });
//   }
...
//     if (isBookmarked) {
//       // Remove bookmark
//       bookmarkedHerbs.remove(widget.herbName);
//       showToast('Removed from bookmarks');
//     } else {
//       // Add bookmark
//       bookmarkedHerbs.add(widget.herbName);
